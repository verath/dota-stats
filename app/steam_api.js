 ...
 * @param {number} [status=500] An HTTP status code for the error.
 * @constructor
 */
 ...
 * @private
 */
SteamApi.prototype._queueApiRequest = function (url) {
    /** @type {SteamApi} */
    var _this = this;
    /** @type {q.defer} */
 ...
 * @private
 */
SteamApi.prototype._httpGet = function (path, queryParams) {
 ...
 * @private
 */
SteamApi.prototype._cachedHttpGet = function (path, queryParams, expire) {
    var expireTime;
    if (expire) {
        expireTime = expire;
    } else {
 ...
 * @private
 */
SteamApi.prototype._apiMethodExists = function (interfaceName, methodName, versionNumber) {
    return (
 ...
 * @return {boolean} True if queryParams contains all required parameters.
 * @private
 */
SteamApi.prototype._hasRequiredParameters = function (interfaceName, methodName, versionNumber, queryParams) {
 ...
 */
SteamApi.prototype.doApiCall = function (interfaceName, methodName, versionNumber, queryParams, cache) {
